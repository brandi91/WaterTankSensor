...
| Device/tank | `device` String; `tank`, `clearance` float; `interval` ulong | hostname; configured tank defaults; positive tank, nonnegative clearance, interval 1–86400 s | matching fields and template values |
